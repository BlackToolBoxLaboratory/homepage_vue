<template>
  <module-page class="btb-pkg-table-example-info">
    <module-page-head :title="translate(langIndex, 'package.table.example.info.title')" :btnList="packageInfo.linkList"
      @clickBtn="openLink" />
    <module-section>
      <template #head>
      ...
      <p>
        {{ translate(langIndex, 'package.table.example.info.description') }}
      </p>
    </module-section>
    <module-section>
      <template #head>
      ...
      <btb-vue-table class="table_sample" :headData="headData" :bodyData="bodyData" mode="info" />
    </module-section>
    <module-section>
      <template #head>
...
export default defineComponent({
  name: "btb-pkg-table-example-info",
  setup() {
