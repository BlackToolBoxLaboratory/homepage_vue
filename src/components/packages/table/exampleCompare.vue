<template>
  <module-page class="btb-pkg-table-example-compare">
    <module-page-head :title="translate(langIndex, 'package.table.example.compare.title')" :btnList="packageInfo.linkList"  @clickBtn="openLink"/>
    <module-section>
      <template #head>
      ...
      <p>
        {{ translate(langIndex, 'package.table.example.compare.description')}}
      </p>
    </module-section>
    <module-section>
      <template #head>
...
export default defineComponent({
  name: "btb-pkg-table-example-compare",
  setup() {
