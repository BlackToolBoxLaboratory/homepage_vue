...
{{exampleEntryObj}}
        ...
        <btb-vue-table class="page_table block_item" :headData="tableHeadArr_property" :bodyData="tableBodyArr_head" xScrollable />
      </module-block>
      <module-block>
      <template #title>
        {{'dataObj'}}
  ...
  data () {
    return {
      env: {
        ...
        btnList: [
          { id: 'github', fa: ['fab', 'github'], url: 'https://github.com/BlackToolBoxLaboratory/vue-table' },
          { id: 'npm', fa: ['fab', 'npm'], url: 'https://www.npmjs.com/package/@blacktoolbox/vue-table' }
        ]
      },
      ...
      tableBodyArr_head: [
        { title: 'index', type: 'String', default: 'undefined', notice: 'As an identity to column and also an index to key name of dataObj' },
        { title: 'name', type: 'String', default: 'undefined', notice: 'The name of table\'s head.' }
      ],
      tableBodyArr_body: [
